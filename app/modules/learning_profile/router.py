"""
learning_profile module router - thin, delegates to service.py (Phase 5 §7).
...
router = APIRouter(prefix="/learning_profile", tags=["learning_profile"])


@router.get("/ping")
async def ping() -> dict[str, str]:
    return {"module": "learning_profile", "status": "ok"}
